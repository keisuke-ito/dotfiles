...
function left-prompt {
  ...
  host_b='93m\]'    # user name background color
  name_t='015m\]'
  name_b='130m\]'
  ...
  echo "${host} \h ${back_color}${name_b}${text_color}${host_b}${sharp}${reset}${user} \u ${back_color}${path_b}${text_color}${name_b}${sharp}${reset}${dir} \w ${reset}${text_color}${path_b}${sharp}${reset}\n$ "
}
